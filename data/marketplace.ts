...
export const seedMembers: ReadonlyArray<Member> = [
  ...
  {
    id: 'pending-4',
    fullName: 'Joaquín Méndez',
    lastInitial: 'M',
    email: 'joaquin.m@example.com',
    memberSince: '2025-02-19',
    zone: 'Roldán',
    accountStatus: 'pending',
    role: 'member',
    approvedBy: null,
  ...
  {
    id: 'suspended-1',
    fullName: 'Federico Aguirre',
    lastInitial: 'A',
    email: 'fede.a@example.com',
  ...
  },
  {
    ...
    role: 'member',
    approvedBy: 'admin-1',
    approvedAt: '2026-05-04T16:30:00Z',
  },
  {
    id: 'rejected-1',
    fullName: 'Bruno Salazar',
    lastInitial: 'S',
  ...
  {
    id: 'member-9',
    fullName: 'Iván Cabrera',
    lastInitial: 'C',
    email: 'ivan.c@example.com',
